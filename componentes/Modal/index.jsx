...
const Modal = ({ show, close }) => {
  ...
  const openModal = () => {
    Animated.sequence([
      ...
      Animated.spring(state.modal, { toValue: 0, bounciness: 5, useNativeDriver: true ,tabBarVisible: false,})
    ]).start()
  }
